...
class MSTypes():
    ...
    def guessApplicationType(self, documentPath):
        ...
        if extension.lower() in (".xls", ".xlt"):
            result = self.XL97
        elif extension.lower() in (".xlsb", ".xlsx", ".xlsm", ".xltm", ".xltx", ".xlam"):
            result = self.XL
        elif extension.lower() in (".doc", ".dot"):
            result = self.WD97
            ...
            result = self.MPP
        elif extension.lower() in (".ppt", ".pot", ".pps"):
            result = self.PPT97
        elif extension.lower() in (".pptx", ".pptm", ".potm", ".ppsm"):
            result = self.PPT
